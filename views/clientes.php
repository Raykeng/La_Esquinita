        ...
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body text-center">
                    ...
                    <h4 id="clientes-con-nit">0</h4>
                    <small>Clientes con NIT</small>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            ...
            <div class="modal-body">
                <form id="form-cliente">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">NIT (8 dígitos)</label>
                                <input type="text" class="form-control" id="cliente-nit" placeholder="12345678"
                                    maxlength="8" pattern="[0-9]{8}">
                                <small class="text-muted">Opcional - Solo números, 8 dígitos</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="cliente-direccion" rows="2"
            ...
            <div class="modal-body">
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <div class="card bg-info text-white">
                            <div class="card-body text-center">
                                <h5 id="historial-nit">Sin NIT</h5>
...
<script>
    ...
    function mostrarClientes(clientesArray) {
        ...
        clientesArray.forEach(cliente => {
            ...
            <tr>
                ...
                <td>
                    ${cliente.nit ? `<span class="badge bg-info">${cliente.nit}</span>` : '<span class="text-muted">Sin NIT</span>'}
                </td>
                <td>
    ...
    function actualizarEstadisticas() {
        ...
        const clientesConNit = clientes.filter(c => c.nit && c.nit.length === 8).length;
        ...
        document.getElementById('clientes-con-nit').textContent = clientesConNit;
    ...
    async function guardarCliente() {
        ...
        if (clienteData.nit && !/^[0-9]{8}$/.test(clienteData.nit)) {
            Swal.fire('Error', 'El NIT debe tener exactamente 8 dígitos numéricos', 'error');
            return;
        }
    ...
    async function verHistorial(clienteId) {
        ...
        document.getElementById('historial-nit').textContent = cliente.nit || 'Sin NIT';
