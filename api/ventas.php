...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt = $pdo->prepare("
            INSERT INTO ventas (folio, cliente_id, subtotal, descuento_total, total, metodo_pago, monto_recibido, cambio, estado) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'completada')
        ");
        $stmt->execute([$folio, $cliente_id, $subtotal, $descuento_total, $total, $metodo_pago, $monto_recibido, $cambio]);
